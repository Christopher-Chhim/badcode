/**
 * Demo of working test functions with mock data
 * This shows that your testing infrastructure is working correctly
 */
...
const mockSuccessResponse = {
  success: true,
  data: mockResponses.success,
  duration: 1500,
  status: 200,
  headers: { 'content-type': 'application/json' }
};

displayTestResults(mockSuccessResponse, "MOCK SUCCESS");
...
const payloads = {
  basic: testPayloads.basic('https://github.com/facebook/react.git', 123),
  security: testPayloads.security('https://github.com/facebook/react.git', 123),
  performance: testPayloads.performance('https://github.com/facebook/react.git', 123),
  custom: testPayloads.custom({
    repoUrl: 'https://github.com/facebook/react.git',
    prNumber: 123,
    extra: { focus_areas: ['security', 'performance'] }
  })
};
...
// Demo 3: Show mock responses
console.log("\n📋 Demo 3: Mock Response Types");
console.log("-" .repeat(40));

Object.entries(mockResponses).forEach(([name, response]) => {
  console.log(`\n${name.toUpperCase()} Response:`);
  displayTestResults({ success: true, data: response }, name.toUpperCase());
});

// Demo 4: Show the issue with CodeRabbit API
console.log("\n📋 Demo 4: CodeRabbit API Issue Analysis");
console.log("-" .repeat(40));
